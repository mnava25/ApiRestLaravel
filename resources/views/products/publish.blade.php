        ...
        <div class="card">
          ...
          <div class="card-body">
            <form method="POST" action="{{ route('products.publish') }}" enctype="multipart/form-data">
              ...
              <div class="form-group row">
                <label for="details"
                       class="col-md-4 col-form-label text-md-right">Details</label>
              ...
              <div class="form-group row">
                <label for="picture"
                       class="col-md-4 col-form-label text-md-right">Picture</label>

                <div class="col-md-6">
                  <div class="custom-file">
                    <input type="number" min="1"
                           class="custom-file-input" name="picture"
                           required>
                    <label for="" class="custom-file-label">Select file...</label>
                  </div>
                </div>
              </div>
